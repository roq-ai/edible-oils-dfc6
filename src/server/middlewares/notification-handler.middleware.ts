...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'product.create': {
    roles: ['business-owner', 'sales-representative', 'customer-service-representative'],
  ...
  'order.update': {
    roles: ['business-owner', 'inventory-manager', 'customer-service-representative'],
    key: 'order-status-updated',
    tenantPath: ['organization', 'product', 'order_item', 'order'],
    userPath: [],
  },
};
